...
btnSugerencia.addEventListener("click", ()=>{
    alert("Si vas a cargar actividades con elementos, hacelo en orden. Por ejemplo, si son dos montajes, poné uno y luego sus elementos; y despues lo mismo con el otro")
})

//Declaro constructor por si quieren guardar los puntos
class Puntos{
